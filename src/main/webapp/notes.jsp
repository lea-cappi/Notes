...
<html>
    ...
    <body>
        <%
            ...
            System.out.println("------------------a cargar header.jsp---------------------------");
        
        %>
        
        <jsp:include page="/WEB-INF/pages/commons/header.jsp"/>
        <%
            System.out.println("------------------a cargar navigation.jsp---------------------------");
        
        %>
        <jsp:include page="/WEB-INF/pages/commons/navigation.jsp"/>
        <%
            System.out.println("------------------a cargar noteList.jsp---------------------------");
        
        %>
        <jsp:include page="/WEB-INF/pages/operations/notesList.jsp"/>
        <%
            System.out.println("------------------a cargar footer.jsp---------------------------");
